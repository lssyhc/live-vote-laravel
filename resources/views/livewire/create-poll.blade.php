        ...
        <div class="rounded-lg bg-white p-6 shadow-md">
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    id="title" type="text" placeholder="Apa topik polling Anda?" wire:model.live="form.title">
                @error('form.title')
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-2 flex items-center space-x-2" wire:key="options.{{ $index }}">
                        <input
                            ...
                            wire:model.live="form.options.{{ $index }}">
                        <button
                    ...
                    @error("form.options.$index")
                        <div class="mt-1 pl-1 text-sm text-red-500">{{ $message }}</div>
                    @enderror
                </div>
            @endforeach
            @error('form.options')
                <div class="mb-4 mt-1 pl-1 text-sm text-red-500">{{ $message }}</div>
            @enderror
